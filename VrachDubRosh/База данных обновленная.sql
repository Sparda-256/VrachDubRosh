...
INSERT INTO DocumentTypes (DocumentName, Description, IsRequired, MinimumAge, MaximumAge, ForAccompanyingPerson)
VALUES
-- Документы для пациентов
('Направление (форма 057-У)', 'Направление на госпитализацию в системе ЕЦП по программе ОМС', 1, 0, 200, 0),
('Справка об отсутствии противопоказаний', 'Заверенная ВК', 1, 0, 200, 0),
('Страховой полис', 'Ксерокопия', 1, 0, 200, 0),
('Свидетельство о рождении', 'Ксерокопия (для детей до 14 лет)', 1, 0, 14, 0),
('Паспорт', 'Ксерокопия (с 14 лет)', 1, 14, 200, 0),
('СНИЛС', 'Ксерокопия', 1, 0, 200, 0),
('Прививочный сертификат', 'Ксерокопия', 1, 0, 200, 0),
('Справка МСЭ', 'Ксерокопия', 1, 0, 200, 0),
('Выписка из амбулаторной карты (форма 112-У)', 'О состоянии здоровья в настоящее время', 1, 0, 200, 0),
('Выписка из истории болезни', 'Последняя госпитализация', 1, 0, 200, 0),
('Выписка из истории болезни при повторной госпитализации', 'Ксерокопия', 0, 0, 200, 0),
('Заключение специалиста по основному заболеванию', 'Травматолог, кардиолог, невролог и др.', 1, 0, 200, 0),
('Клинический анализ крови', NULL, 1, 0, 200, 0),
('Анализ мочи', NULL, 1, 0, 200, 0),
('Анализ кала на яйца глистов', NULL, 1, 0, 200, 0),
('Соскоб на я/г', 'Альтернатива анализу кала на яйца глистов', 0, 0, 200, 0),
('Электрокардиограмма', NULL, 1, 0, 200, 0),
('Электроэнцефалограмма', 'Для детей с неврологической патологией', 0, 0, 200, 0),
('Справка от дерматолога', NULL, 1, 0, 200, 0),
('Справка об отсутствии контактов с инфекционными больными', 'Выдается педиатром или эпидемиологом', 1, 0, 200, 0),
('Результат бактериологического посева кала', 'Для детей до 2-х лет', 1, 0, 2, 0),
('Анализ крови на RW', 'Для детей с 14 лет', 1, 14, 200, 0),
('Результат флюорографии', 'Для детей с 15 лет', 1, 15, 200, 0),

-- Документы для сопровождающих лиц
('Документ, удостоверяющий личность', 'Для сопровождающего лица', 1, 0, 200, 1),
('Полис ОМС', 'Для сопровождающего лица (ксерокопия)', 1, 0, 200, 1),
('СНИЛС', 'Для сопровождающего лица (ксерокопия)', 1, 0, 200, 1),
('Результат бактериологического посева кала на дизентерийную группу и сальмонеллёз', 'Для сопровождающего лица', 1, 0, 200, 1),
('Результат флюорографии или заключение фтизиатра', 'Для сопровождающего лица', 1, 0, 200, 1),
('Анализ крови на RW', 'Для сопровождающего лица', 1, 0, 200, 1),
('Доверенность от законных представителей', 'Если сопровождающий не является законным представителем', 0, 0, 200, 1); 