...
CREATE TABLE Doctors (
    ...
    Password NVARCHAR(100),
    WorkExperience INT,
    GeneralName NVARCHAR(100) -- Добавлено: общее наименование
);
...
VALUES
('Иванов Иван Иванович', 'Врач ЛФК', '101', '1', 15, 'ЛФК'),
('Петрова Мария Сергеевна', 'Специалист по механотерапии', '102', '1', 8, 'Механотерапия'),
('Сидоров Алексей Петрович', 'Физиотерапевт', '103', '1', 12, 'Физиотерапевтические процедуры'),
('Кузнецова Елена Александровна', 'Массажист', '104', '1', 14, 'Массаж'),
('Смирнов Дмитрий Андреевич', 'Рефлексотерапевт', '105', '1', 9, 'Рефлексотерапия'),
('Новикова Ольга Викторовна', 'Психолог', '106', '1', 18, 'Психолог'),
('Морозов Сергей Николаевич', 'Логопед', '107', '1', 16, 'Логопед'),
('Волкова Анна Игоревна', 'Эрготерапевт', '108', '1', 7, 'Эрготерапевт'),
('Соколов Максим Владимирович', 'Специалист по вибромассажу', '109', '1', 13, 'Вибромассаж'),
('Лебедева Наталья Михайловна', 'Специалист по спелеотерапии', '110', '1', 10, 'Спелеотерапия'),
('Козлов Андрей Юрьевич', 'Специалист по грязевым аппликациям', '111', '1', 17, 'Грязевые аппликации'),
('Павлова Ирина Васильевна', 'Специалист по электрогрязи и парафину', '112', '1', 11, 'Электрогрязь, парафин'),
('Григорьев Илья Дмитриевич', 'Специалист по гидротерапии', '113', '1', 14, 'Души'),
('Соловьева Алина Викторовна', 'Специалист по бальнеотерапии', '114', '1', 12, 'Ванны');
